...
public class AdminController {
    ...
    public ResponseEntity<ApiResponse> banUser(@PathVariable("userIdx") int userIdx) {
    ...
    @PostMapping("/add")
    public ResponseEntity<ApiResponse> addAdmin(@RequestBody AddAdminRequest request) {
    ...
    public ResponseEntity<ApiResponse> deleteAdmin(@PathVariable int admin_idx) {
