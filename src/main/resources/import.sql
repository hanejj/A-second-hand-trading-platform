...
('user8@gmail.com', 'passwd8', '유재석', '2001-07-28', 'M', '010-3333-2232', '유재석맞습니다', '서울시', '/uploads/mcyoo.jpg', '유재석 본인 맞아요~', 80);
...
('사기꾼 신고합니다.', '이미 사용한 기프티콘을 멀쩡한 척 판매하고 있어요. 사기꾼입니다.', 2, 'pending', 6, 28, NOW()),
('불법 약물을 거래하는 것 같아요.', '불법 약물처럼 보여요. 이런 건 거래되서는 안 됩니다!', 2, 'pending', 7, 30, NOW()),
('이 계정 사칭 같아요.', '진짜 유재석이 아니에요! 조사 결과, 사칭이 맞습니다. ', 2, 'pending', 8, null, NOW());
